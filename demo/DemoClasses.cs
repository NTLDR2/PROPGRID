...
namespace PROPGRID_DEMO
{
    ...
    public class Person
    {
        ...
        public Person()
        {
            ...
            this.BirthDate = new DateTime(1996, 5, 12);
            this.Income = 50000;
    ...
    public class Vehicle : ICustomTypeDescriptor, INotifyPropertyChanged
    {
        ...
        public Vehicle()
        {
            this.Brand = CarBrand.Toyota;
            this.TypeOfCar = CarType.Sedan;
            this.Model = "Camry";
            this.Year = 2022;
            this.Plate = "XYZ-1234";
            this.Volume = 50;
    ...
    public class Place
    {
        ...
        public Place()
        {
            ...
            this.City = "Amsterdam";
            this.Province = "North Holland";
            this.Postal = "1011 AB";
            this.Country = CountryInfo.Countries[7]; // Netherlands
            this.Floors = 2;
            this.CurrentValue = 350000;
            this.FirstName = "Jane";
            this.LastName = "Smith";
        }
    }
